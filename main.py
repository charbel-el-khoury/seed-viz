...
image = ee.Image("projects/ee-speckerfelix/assets/seed_pipeline_temporary/PIPELINE_RUNS/v1_2_0/prianka/2024-06-21/15-50-12/output/ecosystem_connectivity_kernel").rename("Ecosystem Connectivity")
image2 = ee.Image("projects/ee-speckerfelix/assets/seed_pipeline_temporary/PIPELINE_RUNS/v1_2_0/prianka/2024-06-21/15-50-12/output/ecosystem_function_kernel").rename("Ecosystem Function")
image3 = ee.Image("projects/ee-speckerfelix/assets/seed_pipeline_temporary/PIPELINE_RUNS/v1_2_0/prianka/2024-06-21/15-50-12/output/ecosystem_structure_kernel").rename("Ecosystem Structure")
image4 = ee.Image("projects/ee-speckerfelix/assets/seed_pipeline_temporary/PIPELINE_RUNS/v1_2_0/prianka/2024-06-21/15-50-12/output/genetic_animals_kernel").rename("Genetic Animals")
image5 = ee.Image("projects/ee-speckerfelix/assets/seed_pipeline_temporary/PIPELINE_RUNS/v1_2_0/prianka/2024-06-21/15-50-12/output/genetic_microbes_kernel").rename("Genetic Microbes")
image6 = ee.Image("projects/ee-speckerfelix/assets/seed_pipeline_temporary/PIPELINE_RUNS/v1_2_0/prianka/2024-06-21/15-50-12/output/genetic_plants_kernel").rename("Genetic Plants")
image8 = ee.Image("projects/ee-speckerfelix/assets/seed_pipeline_temporary/PIPELINE_RUNS/v1_2_0/prianka/2024-06-21/15-50-12/output/species_animals_kernel").rename("Species Animals")
image9 = ee.Image("projects/ee-speckerfelix/assets/seed_pipeline_temporary/PIPELINE_RUNS/v1_2_0/prianka/2024-06-21/15-50-12/output/species_microbes_kernel").rename("Species Microbes")
image10 = ee.Image("projects/ee-speckerfelix/assets/seed_pipeline_temporary/PIPELINE_RUNS/v1_2_0/prianka/2024-06-21/15-50-12/output/species_plants_kernel").rename("Species Plants")
image7 = ee.Image("projects/ee-speckerfelix/assets/seed_pipeline_temporary/PIPELINE_RUNS/v1_2_0/prianka/2024-06-21/15-50-12/output/seed_index_kernel").rename("Seed Index")
